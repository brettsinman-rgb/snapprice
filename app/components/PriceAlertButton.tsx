  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex h-10 items-center justify-center rounded-full border border-[#262626]/15 bg-white px-5 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#262626] shadow-sm transition hover:border-[#5ec2a4]/50 hover:bg-[#81dcc1]/10 disabled:cursor-not-allowed disabled:opacity-45"
      >
        Watch Price
      </button>

      {open && (
        <div className="absolute right-0 top-12 z-30 w-[min(320px,calc(100vw-2rem))] rounded-3xl border border-[#5ec2a4]/20 bg-white p-4 text-[#262626] shadow-xl">
          ...
          <label className="mt-4 block">
            ...
            <input
              ...
              className="mt-1 h-11 w-full rounded-[22px] bg-[#f8f9f6] px-4 text-sm font-medium outline-none ring-1 ring-black/10 transition focus:ring-2 focus:ring-[#5ec2a4]/45"
            />
          </label>
          <button
            type="button"
            onClick={createAlert}
            disabled={loading}
            className="mt-4 inline-flex h-10 w-full items-center justify-center rounded-full bg-[#111111] px-4 text-[11px] font-bold uppercase tracking-[0.18em] text-white transition hover:bg-[#5ec2a4] disabled:cursor-wait disabled:opacity-60"
          >
      ...
      {message && (
        <div className="absolute right-0 top-12 z-40 w-[min(320px,calc(100vw-2rem))] rounded-2xl border border-[#5ec2a4]/20 bg-white p-4 text-sm shadow-xl">
